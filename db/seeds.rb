...
Stock.create([{category_id: 1, user_id: 1, name: 'TESLA', content: 'American number 1 electric vehical right now', price: 703.98},{category_id: 3, user_id: 2, name: 'AMAZON', content: 'Online mall', price: 3424.94},{category_id: 4, user_id: 3, name: 'CATAPILLER', content: 'manufacture of construction and mining equipment', price:230.34},{category_id: 5, user_id: 3, name: 'HIVE', content: 'Marijuana Delevery buisness based in Northern Cal.',price:0.90},
{category_id: 3, user_id: 2, name: 'AMC', content: 'One of the biggest movie theaters in America', price:11.36}])
